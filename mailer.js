  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:700px;margin:auto">
        ...
        <div style="padding:24px;background:#f9fafb">
          <h2>Guía N° ${guia.numero_guia}</h2>
          <p>El despacho ha sido <strong>recepcionado exitosamente</strong>.</p>
          <table style="width:100%;border-collapse:collapse">
            <tr><td style="padding:10px;color:#666">Cliente</td><td style="padding:10px;font-weight:bold">${guia.cliente_nombre}</td></tr>
            <tr><td style="padding:10px;color:#666">Destino</td><td style="padding:10px">${guia.punto_llegada}</td></tr>
